...
export type ElectronServiceGlobalOptions = Pick<ElectronServiceOptions, 'clearMocks' | 'resetMocks' | 'restoreMocks'> & {
    rootDir?: string;
    /**
...
export type PathGenerationErrorType = 'CONFIG_MISSING' | 'CONFIG_INVALID' | 'CONFIG_WARNING' | 'MULTIPLE_BUILD_TOOLS' | 'NO_BUILD_TOOL' | 'UNSUPPORTED_PLATFORM';
export type PathValidationErrorType = 'FILE_NOT_FOUND' | 'NOT_EXECUTABLE' | 'PERMISSION_DENIED' | 'IS_DIRECTORY' | 'ACCESS_ERROR';
...
type BrowserBase = SelectorsBase & {
    addCommand<T extends boolean>(queryName: string, commandFn: (this: T extends true ? ElementBase : BrowserBase, ...args: unknown[]) => void, isElementCommand?: T): unknown;
};
...
type ElectronServiceRequestedStandaloneCapabilities = Capabilities.RequestedStandaloneCapabilities & ElectronServiceCustomCapability;
type ElectronServiceRequestedMultiremoteCapabilities = Capabilities.RequestedMultiremoteCapabilities & ElectronServiceCustomCapability;
export type ElectronServiceCapabilities = ElectronServiceRequestedStandaloneCapabilities[] | ElectronServiceRequestedMultiremoteCapabilities | ElectronServiceRequestedMultiremoteCapabilities[];
