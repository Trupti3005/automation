...
async function validateBinaryPaths(binaryPaths) {
    ...
    for (const binaryPath of binaryPaths) {
        try {
            ...
            await fs.access(binaryPath, constants.X_OK || 1); // X_OK is typically 1, fallback for tests
...
export { createLogger, generateBinaryPaths, getAppBuildInfo, getBinaryPath, getElectronVersion, selectExecutable, validateBinaryPaths };
